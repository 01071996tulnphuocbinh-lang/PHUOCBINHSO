...
const feedbackSlice: StateCreator<FeedbackSlice> = (set, get) => ({
    ...
    createFeedback: async (
        ...
        try {
            ...
            const rs = await serviceContainer.createFeedbackUseCase.execute(
                feedback,
                organizationId,
            );
    ...
    getFeedbacks: async (params: GetFeedbacksParams) => {
        try {
            ...
            const feedbacks =
                await serviceContainer.getFeedbacksUseCase.execute(params);
    ...
    getFeedbackTypes: async (params: GetFeedbackTypeParams) => {
        try {
            ...
            const feedbackTypes =
                await serviceContainer.getFeedbackTypesUseCase.execute(params);
            set(state => ({
                ...state,
